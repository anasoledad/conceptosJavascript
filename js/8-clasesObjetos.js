...
//         this._titulo = titulo; //Esto es una simulación de una propiedad privada
//         this.genero = genero; //Esto es una propiedad pública
//         this.#precio = precio; //Est0 es una propiedad privada
//         this.desarrolador = desarrollador;
...
//     // Métodos que modifican propiedades públicas
//     getGenero(){
//         return this.genero;
//     }
...
//         <li>Desarrolador: ${this.desarrollador}</li>
//         <li>Lanzamiento: ${this.lanzamiento}</li>
//         <li>Valoración: ${this.valoracion}</li>
//         </ul>
//         `)
//     }
// }
...
// super_mario._titulo = 'Super mario world';
// super_mario.setGenero('Carreras');
// super_mario.precio = 500;
// document.write(`Título: ${super_mario.titulo} <br>`);
...
// document.write(`Valoración: ${super_mario.valoracion} <br>`);
